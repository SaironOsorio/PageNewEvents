        ...
        <nav class="bg-white border-gray-200">
            ...
            @auth
                ...
                @else
                    ...
                    <a type="button" href="{{ url('admin') }}" class="hidden md:inline-flex py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-700 focus:ring-4 focus:ring-gray-100">
                        Panel de Control
                    </a>
                    @endif
                    <a type="button" href="{{ route('profile') }}" class="hidden md:inline-flex py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-700 focus:ring-4 focus:ring-gray-100">
                        Ver Perfil
                    </a>        
                 @endif
            @else
                <a type="button" class="hidden md:inline-flex text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center me-2 mb-2 cursor-pointer" href="{{ route('login') }}">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                ...
                <li>
                    <x-navbar-link :active="request()->routeIs('eventos') || request()->routeIs('event.detail') || request()->routeIs('event.flights')" href="{{url('eventos')}}" >Eventos </x-navbar-link>
                </li>
                <li>
                ...
                @auth
                    ...
                    @endif
                @else
                    <a type="button" class="hidden md:inline-flex text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center me-2 mb-2 cursosr-pointer" href="{{ route('login') }}">
